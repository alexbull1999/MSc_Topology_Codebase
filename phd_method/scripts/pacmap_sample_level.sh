#!/bin/bash
#SBATCH --job-name=pacmap
#SBATCH --partition=a16gpu
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --output=../logs/PACMAP_sample_level_%j.out
#SBATCH --error=../logs/PACMAP_sample_level_%j.err
...
echo ""
echo "Starting PACMAP Analysis..."
echo ""

export PYTHONUNBUFFERED=1

python phd_method/src_phd/pacmap_sample_visualisations.py 
