#!/bin/bash
#SBATCH --job-name=anli_sbert_all_rounds
#SBATCH --partition=a16
#SBATCH --time=48:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --output=../logs/anli_processing_sbert_%j.out
#SBATCH --error=../logs/anli_processing_sbert_%j.err
...
python MSc_Topology_Codebase/entailment_surfaces/anli_text_processing_sbert.py 
