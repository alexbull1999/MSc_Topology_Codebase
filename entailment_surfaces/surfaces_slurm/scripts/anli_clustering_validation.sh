#!/bin/bash
#SBATCH --job-name=anli_clustering_validation
#SBATCH --partition=a16
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --output=../logs/ANLI_CLUSTERING_VALIDATION_%j.out
#SBATCH --error=../logs/ANLI_CLUSTERING_VALIDATION_%j.err
...
python entailment_surfaces/anli_clustering_validation_sbert.py 
