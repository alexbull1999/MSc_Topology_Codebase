...
#SBATCH --mem=32G
#SBATCH --output=../logs/GPT_MNLI_CLUSTERING_VALIDATION_ADAPTIVE_%j.out
#SBATCH --error=../logs/GPT_MNLI_CLUSTERING_VALIDATION_ADAPTIVE_%j.err
...
python entailment_surfaces/phdim_clustering_validation_v2_GPT2_adaptive.py 
