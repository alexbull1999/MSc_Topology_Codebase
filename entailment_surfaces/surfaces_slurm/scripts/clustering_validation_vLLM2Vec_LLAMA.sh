...
#SBATCH --mem=128G
#SBATCH --output=../logs/LLM2VEC_MISTRAL_MNLI_CLUSTERING_VALIDATION_ADAPTIVE_%j.out
#SBATCH --error=../logs/LLM2VEC_MISTRAL_MNLI_CLUSTERING_VALIDATION_ADAPTIVE_%j.err
...
python entailment_surfaces/phdim_clustering_validation_v2_llm2vec_llama_adaptive.py 
