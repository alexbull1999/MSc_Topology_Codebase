...
#SBATCH --mem=32G
#SBATCH --output=../logs/xnli_clustering/XNLI_VI_CLUSTERING_VALIDATION_%j.out
#SBATCH --error=../logs/xnli_clustering/XNLI_VI_CLUSTERING_VALIDATION_%j.err
...
# ============================================
LANGUAGE="vi"  # ← Change this for each language
# ============================================
