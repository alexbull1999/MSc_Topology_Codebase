#!/bin/bash
#SBATCH --job-name=gpt2_processing
#SBATCH --partition=gpgpuB
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=../logs/gpt2_processing_mnli_train_%j.out
#SBATCH --error=../logs/gpt2_processing_mnli_train_%j.err
...
python MSc_Topology_Codebase/entailment_surfaces/gpt_text_processing.py 
