...
def main():
    ...
    torch.save(final_report, results_dir / "enhanced_cone_validation_results_snli_10k_asymmetry.pt")
    ...
    torch.save(enhanced_tda_data, results_dir / "enhanced_tda_ready_data_snli_10k_asymmetry.pt")
