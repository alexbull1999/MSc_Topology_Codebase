    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save({
                ...
                'epoch': epoch,
            }, os.path.join(output_dir, "enhanced_order_embeddings_snli_full.pt"))
        else:
            patience_counter += 1
...
def plot_training_progress(trainer: OrderEmbeddingTrainer, save_path: str = "plots/"):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(save_path, 'enhanced_order_embedding_snli_full.png'), dpi=300, bbox_inches='tight')
    plt.close()
