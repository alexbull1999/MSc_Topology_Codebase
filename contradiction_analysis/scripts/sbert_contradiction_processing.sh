...
#SBATCH --mem=32G
#SBATCH --output=../logs/sbert_contradiction_processing_10k_subset_%j.out
#SBATCH --error=../logs/sbert_contradiction_processing_10k_subset_%j.err
...
python contradiction_analysis/extract_snli_contradiction.py 
